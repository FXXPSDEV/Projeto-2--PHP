...
<h1>Formulário de Cadastro </h1>
 ...
 <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="usuario" id="nome" placeholder="Nome">
    </div>
    <div class="form-group col-md-6">
  ...
  <button type="submit" class="btn btn-primary" value="login" id="Cadastrar">Cadastrar</button>
  </div>
</form>
